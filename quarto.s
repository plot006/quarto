...
;
	...
	.macpack	longbranch
	.dbg		file, "quarto.c", 62620, 1632128660
...
;
	...
	lda     #$07
	jmp     L0072
L0071:	dec     _ChooseKoma
	lda     _ChooseKoma
L0072:	sta     _ChooseKoma
;
; printCursor() ;
;
...
;
	...
	lda     #$00
	jmp     L007A
L0079:	inc     _ChooseKoma
	lda     _ChooseKoma
L007A:	sta     _ChooseKoma
;
; printCursor() ;
;
...
L0061:	adc     #$0A
	...
	ldx     #>(_meta_pos1)
	jmp     L0059
L0058:	lda     #<(_meta_pos2)
	ldx     #>(_meta_pos2)
L0059:	jsr     _oam_meta_spr
	sta     _spr
;
